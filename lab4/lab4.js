...
// Extending the Car class with a custom method
...
observedPerson.sayHello(); // Output: Hello (Call Count: 1), I'm Bob.
observedPerson.sayHello(); // Output: Hello (Call Count: 2), I'm Bob.
